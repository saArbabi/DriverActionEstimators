...
model_names = ['mlp_01', 'lstm_01','latent_mlp_08', 'neural_032','neural_idm_128']
...
snips_pred['neural_idm_128'].shape
snips_pred['neural_idm_128'].shape
# snips_pred['neural_idm_128'][0, 0, :, 7]
...
for i in range(73):
    ...
    # for model_name in ['neural_idm_128', 'neural_032']:
